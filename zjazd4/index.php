...
<body>
    <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true): ?>
        ...
        <form action="submit_reservation.php" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
                ...
                <input type="checkbox" id="In-room_safe" name="facilities[]" value="In-room_safe">
                <label for="In-room_safe">In-room Safe</label><br>
                <input type="checkbox" id="Mini-fridge" name="facilities[]" value="Mini-fridge">
                <label for="Mini-fridge">Mini-fridge</label><br><br>
